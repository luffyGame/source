...
namespace Ionic.Zip
{
    ...
    IDisposable
    {
        ...
        public ZipFile(string fileName, System.Action<object> _log)
        {
            try
            {
                _InitInstance(fileName, _log);
            }
            catch (Exception e1)
            {
                throw new ZipException(String.Format("{0} is not a valid zip file", fileName), e1);
        ...
        private void _InitInstance(string zipFileName, System.Action<object> _log)
        {
        ...
        private System.Action<object> log;
