...
namespace FrameWork.Editor
{
	...
	*/
	...
	public class MeshObjExporter : ScriptableObject
	{
		...
		[MenuItem("Game/Export/Export whole selection to single OBJ")]
		...
		[MenuItem("Game/Export/Export each selected to single OBJ")]
