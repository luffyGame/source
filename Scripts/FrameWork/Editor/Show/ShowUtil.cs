...
namespace FrameWork.Editor
{
    public class ShowUtil
    {
        ...
        public static void ShowList<T>(List<T> list,String title, Func<int,T> newOne,Action<int> display,Action<int> onRemove =null)
        {
            EditorGUILayout.BeginVertical();
            EditorGUILayout.LabelField(title + " 数目: " + list.Count);
        ...
        public static void ObjectDraw(UnityEngine.Object obj,string head,Action<UnityEngine.Object> menuSel)
        {
